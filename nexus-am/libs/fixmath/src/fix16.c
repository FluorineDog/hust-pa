...
fix16_t fix16_add(fix16_t a, fix16_t b) {
    ...
    if(!((_a ^ _b) & 0x80000000) && ((_a ^ sum) & 0x80000000)) return fix16_overflow;
...
fix16_t fix16_sub(fix16_t a, fix16_t b) {
    ...
    if(((_a ^ _b) & 0x80000000) && ((_a ^ diff) & 0x80000000)) return fix16_overflow;
...
fix16_t fix16_sadd(fix16_t a, fix16_t b) {
    ...
    if(result == fix16_overflow) return (a >= 0) ? fix16_maximum : fix16_minimum;
...
fix16_t fix16_mul(fix16_t inArg0, fix16_t inArg1) {
    ...
    if(product < 0) {
#ifndef FIXMATH_NO_OVERFLOW
        if(~upper) return fix16_overflow;
#endif
...
fix16_t fix16_mul(fix16_t inArg0, fix16_t inArg1) {
    ...
    if(product_lo < BD) product_hi++;

#ifndef FIXMATH_NO_OVERFLOW
    // The upper 17 bits should all be the same (the sign).
    if(product_hi >> 31 != product_hi >> 15) return fix16_overflow;
#endif
    ...
    if(product_lo > product_lo_tmp) product_hi--;
...
fix16_t fix16_div(fix16_t a, fix16_t b) {
...
#ifndef FIXMATH_NO_OVERFLOW
        if(div & ~(0xFFFFFFFF >> bit_pos)) return fix16_overflow;
#endif
    ...
    if((a ^ b) & 0x80000000) {
#ifndef FIXMATH_NO_OVERFLOW
        if(result == fix16_minimum) return fix16_overflow;
#endif
