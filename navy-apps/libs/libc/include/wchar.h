...
size_t mbsnrtowcs(wchar_t *__restrict, const char **__restrict, size_t, size_t,
                  mbstate_t *__restrict);
#endif
size_t _mbsnrtowcs_r(struct _reent *, wchar_t *, const char **, size_t, size_t,
                     mbstate_t *);
...
size_t wcsnrtombs(char *__restrict, const wchar_t **__restrict, size_t, size_t,
                  mbstate_t *__restrict);
#endif
size_t _wcsnrtombs_r(struct _reent *, char *, const wchar_t **, size_t, size_t,
                     mbstate_t *);
...
int vfwprintf(__FILE *__restrict, const wchar_t *__restrict, __VALIST);
int vswprintf(wchar_t *__restrict, size_t, const wchar_t *__restrict, __VALIST);
...
int vfwscanf(__FILE *__restrict, const wchar_t *__restrict, __VALIST);
int vswscanf(const wchar_t *__restrict, const wchar_t *__restrict, __VALIST);
