...
struct __sFILE {
    ...
    _READ_WRITE_RETURN_TYPE (*_read)
    (struct _reent *, void *, char *, _READ_WRITE_BUFSIZE_TYPE);
    _READ_WRITE_RETURN_TYPE (*_write)
    (struct _reent *, void *, const char *, _READ_WRITE_BUFSIZE_TYPE);
...
#define _REENT_INIT(var)                                                            \
    {                                                                               \
        0, &__sf[0], &__sf[1], &__sf[2], 0, _NULL, 0, 0, _NULL, _NULL, _NULL, 0, 0, \
            _NULL, _NULL, _NULL, _NULL, _NULL, _REENT_INIT_ATEXIT{_NULL, 0, _NULL}, \
            _NULL, _NULL, _NULL                                                     \
    }
...
#define _REENT_INIT(var)                                                            \
    {                                                                               \
        0, (__FILE *)&__sf_fake_stdin, (__FILE *)&__sf_fake_stdout,                 \
            (__FILE *)&__sf_fake_stderr, 0, _NULL, 0, 0, _NULL, _NULL, _NULL, 0, 0, \
            _NULL, _NULL, _NULL, _NULL, _NULL, _REENT_INIT_ATEXIT{_NULL, 0, _NULL}, \
            _NULL, _NULL, _NULL                                                     \
    }
...
#define _REENT_CHECK(var, what, type, size, init) \
    do {                                          \
...
#define _REENT_CHECK_RAND48(var)                                     \
    _REENT_CHECK(var, _r48, struct _rand48 *, sizeof *((var)->_r48), \
                 _REENT_INIT_RAND48((var)))

#define _REENT_INIT_MP(var)                       \
    do {                                          \
        struct _reent *_r = (var);                \
        _r->_mp->_result_k = 0;                   \
...
#define _REENT_INIT(var)                                                                \
    {                                                                                   \
        0, _REENT_STDIO_STREAM(&(var), 0), _REENT_STDIO_STREAM(&(var), 1),              \
            _REENT_STDIO_STREAM(&(var), 2), 0, "", 0, _NULL, 0, _NULL, _NULL, 0, _NULL, \
            _NULL, 0, _NULL,                                                            \
            {{0,                                                                        \
              _NULL,                                                                    \
              "",                                                                       \
