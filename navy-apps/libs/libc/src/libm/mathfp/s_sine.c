...
static const double r[] = {-0.16666666666666665052,     0.83333333333331650314e-02,
                           -0.19841269841201840457e-03, 0.27557319210152756119e-05,
                           -0.25052106798274584544e-07, 0.16058936490371589114e-09,
...
double sine(double x, int cosine) {
    ...
    switch(numtest(x)) {
        ...
        case INF: errno = EDOM; return (z_notanum.d);
    }
    ...
    if(-z_rooteps < y && y < z_rooteps)
        ...
        R = (((((((r[6] * g + r[5]) * g + r[4]) * g + r[3]) * g + r[2]) * g + r[1]) * g +
              r[0]) *
             g);
