...
#endif
    huge = 1e300,
    one = 1.0, invsqrtpi = 5.64189583547756279280e-01, /* 0x3FE20DD7, 0x50429B6D */
...
#else
double __ieee754_j0(x) double x;
#endif
{
...
#else
double __ieee754_y0(x) double x;
#endif
{
...
#else
static double pzero(x) double x;
#endif
{
#ifdef __STDC__
    const double *p, *q;
...
#else
static double qzero(x) double x;
#endif
{
#ifdef __STDC__
    const double *p, *q;
