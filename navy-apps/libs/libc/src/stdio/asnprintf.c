...
char *_asnprintf_r(struct _reent *__restrict ptr, char *buf, size_t *lenp,
...
char *asnprintf(char *__restrict buf, size_t *__restrict lenp, const char *__restrict fmt,
                ...) {
    int ret;
    va_list ap;
    FILE f;
