...
#define luaV_settable(L, t, k, v)                                                       \
    {                                                                                   \
        const TValue *slot;                                                             \
        if(!luaV_fastset(L, t, k, slot, luaH_get, v)) luaV_finishset(L, t, k, v, slot); \
    }
...
LUAI_FUNC void luaV_finishget(lua_State *L, const TValue *t, TValue *key, StkId val,
                              const TValue *slot);
LUAI_FUNC void luaV_finishset(lua_State *L, const TValue *t, TValue *key, StkId val,
                              const TValue *slot);
