...
make_rtl_arith_logic_dog(mul_lo) make_rtl_arith_logic_dog(mul_hi)
    make_rtl_arith_logic_dog(imul_lo) make_rtl_arith_logic_dog(imul_hi)
        make_rtl_arith_logic_dog(div_q) make_rtl_arith_logic_dog(div_r)
            make_rtl_arith_logic_dog(idiv_q) make_rtl_arith_logic_dog(idiv_r)
